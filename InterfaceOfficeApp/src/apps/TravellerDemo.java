...
public class TravellerDemo {
	...
	public static void main(String[] args) {
		...
		allemp[0]=new SalesManager("Asfiya",11,11,1111,101,20000.0f,10000,1000.0f,12);//12 days for SalesManager
		allemp[1]=new Programmer("Manas",12,12,1222,102,10000.0f,2,4,8);//8 days for Programmer
		allemp[2]=new Admin("Sumit",11,13,1444,103,50000.0f,2000.0f);//No daya for Admin
		...
		//need to display info about only TA given to particular employee
		for(Emp e:allemp)
		{
		...
		*/
		...
		//no type casting needed int can be automatically type casted to double
